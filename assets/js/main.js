    ...
    customjsActive: function () {
      ...
      a.on("scroll", function () {
        ...
        $("section").each(function () {
          o >= $(this).offset().top - $(".rs-header").outerHeight() &&
      ...
      function mainSlider() {
        ...
        BasicSlider.on("init", function (e, slick) {
          var $firstAnimatingElements = $(".rs-banner-3:first-child").find(
            "[data-animation]"
          );
        ...
        BasicSlider.on(
          ...
          function (e, slick, currentSlide, nextSlide) {
            var $animatingElements = $(
              '.rs-banner-3[data-slick-index="' + nextSlide + '"]'
            ).find("[data-animation]");
      ...
      $(window).on("scroll", function () {
        ...
        $(".progress-circle").css(
          "stroke-dashoffset",
          113.1 - 113.1 * (scrollTop / (documentHeight - windowHeight))
        );
        if (scrollTop > 150) {
          $("#scrollUp").fadeIn();
        } else {
      ...
      $(window).on("load", function () {
        $(
          ".rs-header .nav-menu a,a[href='#top'],a[rel='m_PageScroll2id']"
        ).mPageScroll2id({
    ...
    OwlCarousel: function () {
      $(".rs-carousel").each(function () {
        ...
        owlCarousel.owlCarousel({
          ...
          nav: nav ? true : false,
          navText: [
            "<i class='ri-arrow-left-fill'></i> <span>Prev</span>",
            "<span>Next</span> <i class='ri-arrow-right-fill'></i>",
          ],
